...
export async function isProjectOwner(projectId: string, userId: string, userRole: string): Promise<boolean> {
  if (userRole === 'owner') {
    return true;
  }
...
export async function isProjectMember(projectId: string, userId: string, userRole: string): Promise<boolean> {
  if (userRole === 'owner') {
    return true;
  }
